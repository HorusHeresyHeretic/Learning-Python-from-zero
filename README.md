...
Поэтому я решил обмазаться дерзостью и объявить эту варп воронку с исключениями инструкцией по изучению языка программирования Python с 0 для тех, кто нигода не занимался программированием как таковым.
