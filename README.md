...
*Свет истины, который Лутц вещает на страницах своей книги просто необходим для работы с исключениями, а исключений у вас будет много. Считайте, что книжка Лутца нужна для работы с исключениями. Прикладным программистам в этом отношении проще - списко возможных исключений, которые они получают, как правило, ограничен стандартной бибилиотекой Python. Но, Python любит длинные шапки import as и если вы собираетесть работать с дополнительными бибилиотеками - понимание того, как работает язык, просто необходимо для обработки исключений при работе с ними.*
