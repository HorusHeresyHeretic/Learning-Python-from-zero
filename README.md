...
В репозитории есть два типа файлов: name.py и name.txt - первые содержат код, который был написан по учебникам и без, вторые представляют собой конспект с материалами учебников и комментариями к ним. 
...
ЗЫ на самом деле понятные учебные курсы есть и их много:

https://github.com/ru-python-beginners/faq/blob/master/README.md

просто я не сразу их нашёл (ибо был космически далёк от ламповой коммуночки питонистов) и изобретал велосипед самостоятельно.
